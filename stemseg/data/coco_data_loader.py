...
class CocoDataLoader(Dataset):
    def __init__(self, base_dir, ids_json_file, category_agnostic):
        super().__init__()
    ...
    def __getitem__(self, index):
        ...
        seq_images, seq_instance_masks, seq_invalid_pts_masks = \
            [image], [instance_masks], [np.zeros((image_height, image_width), np.uint8)]
    ...
    def apply_random_flip(self, image, instance_masks):
    ...
    def apply_random_sequence_shuffle(self, images, instance_masks, invalid_pt_masks):
